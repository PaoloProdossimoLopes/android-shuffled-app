...
class InmemoryDeckListClient private constructor(): GetAllDecksClient, GetFavoritedDecksClient,
    ...
    private val inmemoryDecks = mutableListOf(
        DeckListResponse.Deck(1, "Ingles", "https://s4.static.brasilescola.uol.com.br/be/2022/05/bandeira-dos-estados-unidos.jpg", false, listOf(
        ...
        DeckListResponse.Deck(2, "Frances", "https://www.eurodicas.com.br/wp-content/uploads/2018/10/bandeira-da-franca-1200x900.jpg", false, listOf(
        ...
        DeckListResponse.Deck(3, "Jappones", "https://ichef.bbci.co.uk/news/1024/branded_portuguese/135A8/production/_110227297_gettyimages-512612394.jpg", true, listOf(
...
//        throw Error()
    ...
    override fun postDeck(deck: CreateDeckModel, onComplete: CreateDeckClientCompletionBlock) {
        ...
        inmemoryDecks.add(DeckListResponse.Deck(id, deck.title, deck.imageUri.toString(), false, deck.cards.map { DeckListResponse.Card(it.question, it.answer) }))
